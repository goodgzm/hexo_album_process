...
class Parameters:
    ...
    Image_Root_Path = r'/home/ubuntu/photos'                                   # root of source raw images
    Hexo_Root_Path =r'/home/ubuntu/Myblog-1/blog'                         # root of Hexo dir  
    Hexo_Sub_Dir_to_Photos = r'source/photos'                                   # my source dir for album
    Uploading_Temp_Image_Path = r'/home/ubuntu/Album_Temp'           # root of temp image dir
    ...
    Image_Url_Prefix =r'http://cdn.gzm.red/'                    # prefix of image url
